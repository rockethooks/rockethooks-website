...
RocketHooks converts any REST health, status, or deployment endpoint into a real-time event stream. Define monitors for your CI/CD APIs, cloud provider endpoints, and third-party service status pages, then route changes to the channels your team already uses.
...
4. **Incident channel routing** -- Send critical failures to PagerDuty, warnings to Slack, and all events to your logging pipeline
